        ...
        <div class="row align-items-stretch">
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                <div class="feature h-100">
                    ...
                    <h3 class="mb-4">Giao hàng toàn quốc</h3>
                    <p>Cam kết vận hành tốc độ giao hàng nhanh vượt trội nhằm rút ngắn tối đa thời gian khách hàng nhận
                        được sản phẩm.</p>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                <div class="feature h-100">
                    <div class="icon mb-4">
                        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-shield-lock"
                    ...
                    <h3 class="mb-4">Thanh toán bảo mật</h3>
                    <p>Cam kết bảo mật
            ...
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                <div class="feature h-100">
                    ...
                    <h3 class="mb-4">Dễ dàng đổi trả</h3>
                    <p>Cam kết tư vấn và hỗ trợ quý khách kịp thời, nhiệt tình theo đúng các quy định của pháp luật và
                        chuẩn mực đạo đức nghề nghiệp.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-lg-5">
                <div class="widget mb-4">
                    <a href="index.html" class="logo m-0">ShionHouse<span class="text-primary">.</span></a>
                    <p>Với phương châm <strong>“Chất lượng thật - Giá trị thật”</strong> Shion House luôn nỗ lực không
                        ngừng nhằm nâng cao chất lượng dịch vụ để khách hàng được hưởng các dịch vụ chăm sóc tốt nhất.
                    </p>
                </div>
                <div class="widget">
                    <h3>Tham gia danh sách gửi thư của chúng tôi và nhận độc quyền</h3>
                    <form action="#" class="subscribe">
                        <div class="d-flex">
                            <input type="email" class="form-control" placeholder="Địa chỉ email">
                            <input type="submit" class="btn btn-black" value="Đăng ký">
                        </div>
                    </form>
