                    ...
                    <form class="needs-validation" method="POST" action="">
                        ...
                        <div id="billingAddress" class="row g-4">
                            ...
                            <div class="col-md-12">
                                ...
                                @error('province')
                                    <p class="text-danger mt-2">Vui lòng nhập tỉnh/thành phố</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @error('district')
                                    <p class="text-danger mt-2">Vui lòng nhập huyện/quận</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @error('ward')
                                    <p class="text-danger mt-2">Vui lòng nhập xã/phường</p>
                                @enderror
                            </div>
